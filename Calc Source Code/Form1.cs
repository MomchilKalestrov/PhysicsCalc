    ...
    public partial class Base : Form
    {
        ...
        private void Solve_Click(object sender, EventArgs e)
        {
            ...
            switch (a)
            {
                ...
                case 36:
                    {
                        double Q = Convert.ToInt32(Input1.Text);
                        double t = Convert.ToDouble(Input2.Text);
                        double m = Convert.ToDouble(Input3.Text);
                        double c = (Q / (m * t));
                        MessageBox.Show("Спесифичния топлинен капацитет е равен на: " + Math.Round(c, 2) + " J/(kg.K) ");
                    }
                    break;
                case 37:
                    {
                        double Q = Convert.ToInt32(Input1.Text);
                        double m = Convert.ToDouble(Input2.Text);
                        double λ = (Q / m);
                        MessageBox.Show("Спесифичнaта топлина на топене е равна на: " + Math.Round(λ, 2) + " J/(kg.K) ");
                    }
                    break;
                case 38:
                    {
                        ...
                        double m = Convert.ToDouble(Input2.Text);
                        double r = (Q / m);
                        MessageBox.Show("Спесифичнaта топлина на изпарение е равна на: " + Math.Round(r, 2) + " J./kg ");
                    }
                    break;
                case 39:
                    {
                        double p = Convert.ToInt32(Input1.Text);
                        double V = Convert.ToDouble(Input2.Text);
                        double A = (p / V);
                        MessageBox.Show("Работата на газа е равна на: " + Math.Round(A, 2) + " J ");
                ...
                case 40:
                    {
                        double V = Convert.ToInt32(Input1.Text);
                        double p = Convert.ToDouble(Input2.Text);
                        double T = (p * V);
                        MessageBox.Show("Температурата при изотермения процес е равна на: " + Math.Round(T, 2) + " ℃ ");
                    }
                    break;
                ...
                case 41:
                    {
                        ...
                        double T = Convert.ToInt32(Input2.Text);
                        double V = (p / T);
                        MessageBox.Show("Обемът при изобарния процес е равен на: " + Math.Round(V, 2) + " кб.см ");
                    }
                    break;
                default:
                    {
        ...
        private void formuli1_Load_1(object sender, EventArgs e)
        {
        ...
        private void formuli_Load(object sender, EventArgs e)
        {
